                ...
                <div class="card h-100 border-0">
                    ...
                    <div v-bind:id="'carousel-' + accommodation.id" class="carousel slide">
                        <div class="carousel-inner">
                            <div v-for="(picture, index) in accommodation.pictures" :key="index" class="carousel-item" v-bind:class="{'active' : index === 0}">
                                <img v-bind:src="picture.file_small"
                                    class="d-block w-100 img-fluid img-square"
                                    v-bind:alt="'photo ' + accommodation.name">
                            </div>
                        </div>
                        <button class="carousel-control-prev" type="button" v-bind:data-bs-target="'#carousel-' + accommodation.id"
                            data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" v-bind:data-bs-target="'#carousel-' + accommodation.id"
                            data-bs-slide="next">
