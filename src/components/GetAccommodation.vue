                ...
                <div class="mt-4">
                                ...
                                <div class="col-6">
                                    <div class="row align-items-center g-2 mb-2">
                                        <div class="col-6 text-center">
                                            <img :src="accommodation.pictures[1].file_small"
                                                class="d-block w-100 img-fluid"
                                                v-bind:class="lg ? 'img-16_10' : 'img-square'"
                                                v-bind:alt="'photo ' + accommodation.name">
                                        </div>
                                        <div class="col-6 text-center">
                                            <img :src="accommodation.pictures[2].file_small"
                                                class="d-block w-100 img-fluid"
                                                v-bind:class="lg ? 'img-16_10' : 'img-square'"
                                                v-bind:alt="'photo ' + accommodation.name">
                                        </div>
                                    ...
                                    <div class="row align-items-center g-2">
                                        ...
                                        <div class="col-6 text-center">
                                            <img :src="accommodation.pictures[4].file_small"
                                                class="d-block w-100 img-fluid"
                                                v-bind:class="lg ? 'img-16_10' : 'img-square'"
                                                v-bind:alt="'photo ' + accommodation.name">
                                        </div>
                    ...
                    <div v-if="lg" class="row g-4 mt-2">
                        <div class="col-7">
                            ...
                            <p class="card-text fs-6 m-1">{{ accommodation.streetNumber }} {{ accommodation.streetNam }} - ({{ accommodation.postal }}) {{ accommodation.city }} - {{ accommodation.country }}</p>
                            <p class="card-text fs-6 m-1">{{ accommodation.nbrOfRooms }} chambres - {{ accommodation.maxPerson }} personnes.</p>
                            <hr>
                            <div class="d-flex">
                                <img class="tsh-picture" v-bind:src="accommodation.host.picture" alt="Photo de l'hote">
                                <div>
                                    <p class="card-text fs-6 m-1">Proposé par : {{ accommodation.host.firstName }} {{ accommodation.host.lastName }}</p>
                    ...
                    <div v-else class="row g-4 mt-2">
                        <div>
                            <h1 class="card-title">{{ accommodation.name }}</h1>
                            <p class="card-text fs-6 m-1">{{ accommodation.streetNumber }} {{ accommodation.streetName }} - ({{ accommodation.postal }}) {{ accommodation.city }} - {{ accommodation.country }}</p>
                            <p class="card-text fs-6 m-1">{{ accommodation.nbrOfRooms }} chambres - {{ accommodation.maxPerson }} personnes.</p>
                            <hr>
                            <div class="d-flex">
                                <img class="tsh-picture" v-bind:src="accommodation.host.picture" alt="Photo de l'hote">
